            ...
            if(data.rspCode==='000000'){
                ...
                if(list.length > 0){
                    var html = $.map(list, function (o, i) {
                        ...
                        if (o.locking == true) {
                            if (o.lockUserId == localStorage.getItem('LoginId')) {
                                _td = '<td class="detial noselect lock_td" style="padding: 8px 10px 8px;">' +
                                    '<a class="lock_a" href="approvalThree.html?intoCode='+o.intoCode+'&manualReviewQueue='+o.manualReviewQueue+'&applyTerminal='+o.applyTerminal+'" style="position: relative;">' +
                        ...
                        return '<tr'+ ' data-code='+ o.intoCode +' data-url=approvalThree.html?intoCode='+o.intoCode+'&manualReviewQueue='+o.manualReviewQueue+'&applyTerminal='+o.applyTerminal+'>' +
                            ...
                            // '<td class="detial noselect"><a href="approvalThree.html?intoCode='+o.intoCode+'&manualReviewQueue='+o.manualReviewQueue+'">立即审批</a></td>' +
