		...
		generPageHtml : function(config,enforceInit){
			...
			if(this.isGoPage){
				gopage_info = '&nbsp;'+this.lang.gopageBeforeText+'<span id="'+this.gopageWrapId+'">'+
					...
					'<input type="text" id="'+this.gopageTextboxId+'" onfocus="kkpager.focus_gopage()"  onkeypress="var evt = arguments[0] || window.event; var key = evt.keyCode?evt.keyCode:evt.which; if( key<48 || key>57 ) return false;"   onblur="kkpager.blur_gopage()" value="'+this.next+'" /></span>'+this.lang.gopageAfterText;
			}
