...
//调用分页部分 可以放到公共js 2016-9-21 16:32:00
/**
...
function getHashStringArgs() {//取得查询的hash，并去除开头的#号
...
var kkpager1 = {
    ...
    generPageHtml: function(config, enforceInit) {
        ...
        var gopage_info = "";
        if (this.isGoPage) {
            gopage_info = "&nbsp;" + this.lang.gopageBeforeText + '<span id="' + this.gopageWrapId + '">' + '<input type="button" id="' + this.gopageButtonId + '" onclick="kkpager1.gopage()" value="' + this.lang.gopageButtonOkText + '" />' + '<input type="text" id="' + this.gopageTextboxId + '" onfocus="kkpager1.focus_gopage()"  onkeypress="if(event.keyCode<48 || event.keyCode>57)return false;"   onblur="kkpager1.blur_gopage()" value="' + this.next + '" /></span>' + this.lang.gopageAfterText
        }
        if (this.total <= 8) {//总页数小于9
            for (var i = 1; i <= this.total; i++) {
                if (this.pno == i) {
