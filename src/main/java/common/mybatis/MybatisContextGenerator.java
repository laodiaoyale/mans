 ...
 */
public class MybatisContextGenerator extends IntrospectedTableMyBatis3SimpleImpl {

	private Logger logger = Logger.getLogger("MybatisContextGenerator");
	...
	protected String calculateMyBatis3XmlMapperFileName() {
        ...
        if (stringHasValue(tableConfiguration.getMapperName())) {
            ...
            String name = MessageFormat.format(mapperName, fullyQualifiedTable.getDomainObjectName());
        ...
        logger.info("Mapper:" + sb.toString());
        return sb.toString();
    }
